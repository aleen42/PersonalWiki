...
For **HTML5**, we just specify like this: `<!DOCTYPE html>`. That's because **HTML5** does not belongs to **SGML** any more. That means that we don't need to use **Document Type Definition (DTD)** to include.
