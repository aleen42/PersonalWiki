...
- **FastCGI** is a kind of CGI which is long-live, which will always be running. With FastCGI, it'll take less time t fork.(which is a problem of fork-and-execute mode in CGI)
