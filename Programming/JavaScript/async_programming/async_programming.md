...
Now then, since we have used callback function to handle the result, we don't need to wait for assignment anymore, and just continue to let the code to do anything else.
