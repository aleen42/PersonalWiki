...
The comand will see jsx files in the directory `src/` and build a vanilla JavaScrip file into the directory `build/`, and then we can just import this vanilla JavaScript file.