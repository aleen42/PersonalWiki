...
Then as the Figure 2 shown, how to calculate a proper value of ***a*** for `scale` with ***θ*** for `sita` as the variable, in order that vertexes of the item can stay on each side of another square?
