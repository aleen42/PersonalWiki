...
3. **Visualization and debugging** : When using OpenCV (Python) you have access to a huge number of libraries written for Python. Visualization using matplotlib is about as good as MATLAB. I find debugging code in Python easier than in C++, but it does not quite match the super-easiness of MATLAB.
...
OpenCV is written in C/C++ : One of the great benefits of an open source library is your ability to modify them to suit your needs. If you want to modify OpenCV, you have to modify the C/C++ source.