...
* Coder
    ...
    * [Network](Network/Network.md)
        ...
        * 5 Layers - the structure of  Network
            * [Application Layer](Network/Application/Application.md)
                * [HTTP](Network/Application/http/http.md)
                    * [HTTP Response Status Code](Network/Application/http/http_reponse_status_code/http_reponse_status_code.md)
                    * [HTTP Request Methods](Network/Application/http/http_request_methods/http_request_methods.md)
                    * [Idempotence (幂等性) between HTTP Request Methods](Network/Application/http/idempotence_of_http_methods/idempotence_of_http_methods.md)
                    * [Different versions of HTTP](Network/Application/http/different_versions_of_http/different_versions_of_http.md)
                    * HTTP Headers
                        * [Headers around resource caching](Network/Application/http/resource_caching_headers/resource_caching_headers.md)
                        * [Headers around CORS (Cross-Origin Resource Sharing)](Network/Application/http/cors_headers/cors_headers.md)
    ...
    * [Software Architecture](architecture/architecture.md)
        ...
        * Advanced
            * [Progressive Web Apps (PWA)](architecture/pwa/pwa.md)
