...
&nbsp; &nbsp; &nbsp; &nbsp;如果我希望往代码库中添加一个新的功能或者产生一点影响的话，我将需要推送一个新的分支，并为该分支创建一个拉去请求。此后，我的同事会审视该请求：1）该请求对他们的代码是否产生了改变、2）他们是否感兴趣于该次请求所涉及的问题、3）或者当他们有充足的时间时，会去核对我所提交的改变。审视过后，我们会在不同的机器子集中运行该部分的代码，并在生产环境中尝试各种的测试用例。