...
&nbsp; &nbsp; &nbsp; &nbsp;相反地，React 仅提供一个用于绑定的语法糖。该语法糖称作 valueLink（“value”和“onChange”中都有的一个单一属性）。该概念是如此得简单以至于看起来它并没有产生，但它的确是工作了。当且仅当你了解好这个概念时，你就能创建属于自己的 linkState 或一个相似的函数去实现任何的绑定需求。
