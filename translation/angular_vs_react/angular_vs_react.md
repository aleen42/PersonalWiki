...
&nbsp; &nbsp; &nbsp; &nbsp;相反地，React 仅提供一个用于绑定的语法糖。该语法糖称作 valueLink（“value”和“onChange”中都有的一个单一属性）。该概念看似简单以至于看起来它并没有产生任何作用，而它的确是工作了。因此在创建属于自己的 linkState 或一个相似的函数去实现任何的绑定需求前，我们必须理解好这个 React 所提出的新概念。
