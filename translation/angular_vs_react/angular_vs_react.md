...
&nbsp; &nbsp; &nbsp; &nbsp;Angular 的抽象存在有一定的纰漏。这就意味着只有在清楚地了解底层的模型后，我们才能真正地运用起这些抽象的方法。这就是为什么这么多开发者在调试自身代码的过程中需要大量调试 Angular 框架内部的代码。

&nbsp; &nbsp; &nbsp; &nbsp;为了应付这些纰漏，Angular 为我们提供了类似指令优先级（directive priority）的概念。