...
2. **工具箱**：不管你需要什么，MATLAB 总会为你提供有一个工具箱，包括有一个**视频处理**箱、一个**计算机视觉**箱以及一个**统计及机器学习**箱。这些箱在开发过程中，会为我们提供有大量不同而有效的算法实现。而提供的方法中，我们往往也会看到有清晰而明显的接口。其实，许多的计算机视觉问题都经常可以被当成是与优化相关的问题。