...
同样地，在计算机视觉领域方面的我们，同样会遇到相似的选择问题。到底一个计算机视觉工程师 / 编程人员需要学习哪一个工具呢 —— 使用 C++ 的 OpenCV？使用 Python 的 OpenCV？还是 MATLAB？当然，我们应该庆幸还能有若干个工具供我们选择。因为在十年前，计算机视觉领域并没有一个优质的代码库。