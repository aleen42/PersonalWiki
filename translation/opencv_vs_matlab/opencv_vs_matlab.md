...
有时，我会被那些所谓的编程语言大战逗笑。因为，参与大战的人总纠结于哪门语言最好。然而事实上，编程人员应该懂得为自己的工作，去挑选一门合适的语言。例如，你想快速开发一个 Web 应用程序的话，你可以尝试使用基于 Rails 或 Django 的 Ruby 去进行开发。而若你想为一个嵌入式设备开发高性能的代码，你则可以尝试一下 C。