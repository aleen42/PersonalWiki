...
2. **大量经过优化的代码库**：在 OpenCV 中可用的算法集合，使得库中的其他东西如同相形见绌。此外，该库还通过了性能上的优化。有了 OpenCV 3，你还可以使用[透明的 API](http://www.learnopencv.com/opencv-transparent-api/) 去轻易在你的机器上，调用 OpenCL 兼容性设备（如 GPU）。
