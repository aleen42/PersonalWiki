...
&#160; &#160; &#160; &#160;负载均衡器把流量分发到我们指定的9个初级服务器（01~09）和两个设备/元网络服务器（10~11， 我们搭建的环境）。除了[meta.stackoverflow.com](http://meta.stackoverflow.com/)和[meta.stackexchange.com](http://meta.stackexchange.com/)这两个页面是运行在后面的两台网络服务器之外，像Stack Overflow、Careers和所有的Stack Exchange页面都是运行在初级服务器上。
