...
&#160; &#160; &#160; &#160;第二个组件是一组 Dell R730xd 服务器，每一个服务器都带有768GB 的 RAM、6TB 的 PCIe SSD 空间和 2x8 个核。该组件负责运行其他的所有东西包括 Careers、Open ID、Chat、我们的异常日志和其他每一个 Q&A 网页（Super User和Server Fault等）
