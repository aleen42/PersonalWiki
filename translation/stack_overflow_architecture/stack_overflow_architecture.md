...
也许，此刻你会在思考与2013年相比，为什么ASP.Net在处理时间上会有明显的减少现象(减少了757小时)，而每天却有6100万以上的请求。这是因为我们[在2015年早期做了硬件升级](http://blog.serverfault.com/2015/03/05/how-we-upgrade-a-live-data-center/)，并且在应用级中对应用作出了大量的性能协调。
