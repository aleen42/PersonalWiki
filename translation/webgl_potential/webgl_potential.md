...
&#160; &#160; &#160; &#160;最近，关于 WebGL 将广泛兼容于各平台的谣言炙手可热，尤其是 IE 浏览器。当然，随着谣言的传递，一组真正可跨平台的 GPU API 也随即面世。在我看来，倘若谣言得以实现，那么这将会对 Web 开发中的许多东西都会产生一定的影响，而这种影响在关于人们如何开发交互性内容的话题上显得尤为明显。但是，我也希望这能推进 web 前进。
