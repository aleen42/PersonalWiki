...
- *Note: in Ubuntu 12.04, you should recompile libx264 and ffmpeg with `--enable-static`, `--enable-pic`, and `--enable-shared`.(Be sure that you have completely uninstall ffmpeg before recompile libx264, more [details](http://www.ozbotz.org/opencv-installation/) in step 7 and 8)*.
